...
from models import db, db_drop_and_create_all, setup_db, Actor, Movie, Performance
...
def create_app(test_config=None):
    ...
    app = Flask(__name__)
    setup_db(app)
    migrate = Migrate(app, db)  # Sử dụng db đã nhập từ models.py
    ...
    def login():
        ...
        conn = http.client.HTTPSConnection("dev-iuxikjrwwua3xm2p.us.auth0.com")

        payload = "{\"client_id\":\"g5gmQmFEW2erZ29dADAS2KF4IhZvJ3mG\",\"client_secret\":\"Zu31s4Gj-WykUVlFFdKFvhOiesoJmTvqmBrgcA9yUZzMgCRiQ9BdOvsTku0ftmV5\",\"audience\":\"http://localhost:5000\",\"grant_type\":\"client_credentials\"}"
